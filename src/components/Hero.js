        ...
        <>
            <div className="hero_container">
                <div className="menu">
                    ...
                    <p className="logo1">FOO</p><p className="logo2">BLO</p>
                    </div>
                    ...
                    <div className="search">
                        ...
                        <input className='inputSearch' type="text" name="Hit enter to search" id="" value="Hit enter to search"/>
                    </div>
                </div>
                <div className="mexican">
                    <p className="mexicanText">Mexican Grilled Corn Recipe</p>
                    ...
                    <button className='MexButton'>View Recipes</button>
                </div>
